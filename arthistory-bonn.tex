...
|arthistory-bonn| is a citation style that complies with the citation and bibliography rules of the Institute of History of Art at the University of Bonn, or \enquote*{Kunsthistorisches Institut der Universität Bonn}\footnote{Website: \url{https://www.khi.uni-bonn.de}.} (henceforth KHI). In particular, it introduces
\begin{itemize}
...
Besides loading |arthistory-bonn|, in order to comply with the KHI's bibliography rules, users' actions will be required mostly when entering bibliography items.
