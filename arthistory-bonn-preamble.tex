...
\ihead{\normalfont\footnotesize \texttt{bib}\LaTeX-style \texttt{arthistory-bonn \arthistoryversion
} \copyright\ by Lukas C. Bossert | Thorsten Kemper}%
\rofoot{\normalfont\footnotesize  \textbf{\sffamily \thepage}}
\lofoot{\normalfont\footnotesize  \href{digitales-altertum.de}{digitales-altertum.de}}
...
\hypersetup{					% setup the hyperref-package options
	pdftitle={bib\LaTeX-arthistory-bonn},	% 	- title (PDF meta)
